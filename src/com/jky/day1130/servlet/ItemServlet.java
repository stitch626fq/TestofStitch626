package com.jky.day1130.servlet;

import com.jky.day1130.entity.Items;
import com.jky.day1130.service.ItemService;
                ...
                case "add":
                    ...
                    if (part!=null){
                        ...
                        if (oldName!=null && oldName.lastIndexOf(".")>0){
                            ...
                            //Items对象设置图片信息
//                            String pathPic="/pic/"+newName;
//                            Items items=new Items(name,price,pathPic,createtime,detail);
